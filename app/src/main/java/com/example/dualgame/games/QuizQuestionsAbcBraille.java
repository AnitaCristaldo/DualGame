...
public class QuizQuestionsAbcBraille extends AppCompatActivity implements View.OnClickListener{
    ...
    private ArrayList<QuestionAbcBraille> mQuestionList; // Lista de preguntas en el quiz.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_questions_braille);
        ...
        mQuestionList = ConstantsAbcBraille.getQuestions();
        ...
        btn_back.setOnClickListener(v -> {
            Intent intent = new Intent(QuizQuestionsAbcBraille.this, AbecedarioActivityBraille.class);
        ...
        if (id == R.id.tv_option_one) {
            ...
            if (mSelectedOptionPosition == 0) {
                ...
                if (mCurrentPosition <= mQuestionList.size()) {
                    ...
                    Intent intent = new Intent(QuizQuestionsAbcBraille.this, ResultAbcBraille.class);
                ...
                QuestionAbcBraille question = mQuestionList.get(mCurrentPosition - 1);
