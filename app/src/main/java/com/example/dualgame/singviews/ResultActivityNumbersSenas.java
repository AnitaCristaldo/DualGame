...
import com.example.dualgame.games.ConstantsNumbersSenas;
...
public class ResultActivityNumbersSenas extends AppCompatActivity {
    ...
    private static final String TAG = "ResultActivityNumbersSenas";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_numbers_senas);
        ...
        TextView tvScore = findViewById(R.id.tv_score_numbers_senas);
        // Encuentra y guarda una referencia al TextView con el ID "tv_score" para mostrar el puntaje.

        TextView tvCongratulations = findViewById(R.id.tv_congratulations_numbers_senas); // Referencia al TextView de Felicitaciones
        Button btnFinishNumbersSenas = findViewById(R.id.btn_finish_numbers_senas);
        ...
        int totalQuestions = getIntent().getIntExtra(ConstantsNumbersSenas.TOTAL_QUESTIONS, 0);
        ...
        int correctAnswers = getIntent().getIntExtra(ConstantsNumbersSenas.CORRECT_ANSWERS, 0);
        Log.d(TAG, "Correct Answers received: " + correctAnswers);
        ...
        btnFinishNumbersSenas.setOnClickListener(v -> {
