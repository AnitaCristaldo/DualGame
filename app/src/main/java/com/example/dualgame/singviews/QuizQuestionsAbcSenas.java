...
public class QuizQuestionsAbcSenas extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayList<Question> mQuestionList; // Lista de preguntas en el quiz.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_abc);
        ...
        mQuestionList = ConstantsAbc.getQuestions();
 ...
 /*       btn_back.setOnClickListener(v -> {
            Intent intent = new Intent(QuizQuestionsAbcSenas.this, SubAbcActivity.class);
        ...
        if (id == R.id.tv_option_one) {
            ...
            if (mSelectedOptionPosition == 0) {
                ...
                if (mCurrentPosition <= mQuestionList.size()) {
                    ...
                    Intent intent = new Intent(QuizQuestionsAbcSenas.this, ResultAbcSenas.class);
