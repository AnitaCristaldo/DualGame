    ...
    private void displayUserInfo() {
        ...
        userRef.get().addOnSuccessListener(documentSnapshot -> {
            if (documentSnapshot.exists()) {
                ...
                // Se actualiza el TextView con el mensaje de bienvenida
                userWelcomeMessage.setText(welcomeMessage); // Asignar el mensaje de bienvenida

                // También puedes actualizar el textView si deseas mostrar más información
                textView.setText(lastLoginMessage + "\n" + loginCountMessage);
